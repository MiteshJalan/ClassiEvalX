...
#     preprocessor_obj_file_path=os.path.join('artifacts',"preprocessor.pkl") #give i/p and o/p pipeline pkle file for 

class DataTransformation: 
    def __init__(self,input_name):
        self.data_transformation_config=os.path.join('artifacts',input_name)#will preprocessor_obj_file_path variable. 
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            preprocessing_obj=self.get_data_transformer_object()#has all pipelines
            ...
            input_feature_train_arr=preprocessing_obj.fit_transform(input_feature_train_df)#fit transform train df
